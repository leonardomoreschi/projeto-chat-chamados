 ...
 *
 * O /chat tem a própria sidebar (interativa: seleção de conversa, busca,
 * modais). Esta aqui é a versão de navegação: mesmas ações, lista de conversas
 * ao vivo e clique que leva para /chat?conversa=ID. Quem alimenta é o
...
<aside id="menu-lateral" data-menu-lateral
    ...
    <div class="p-3 space-y-2" data-menu-conteudo>
        ...
        <?php if ($ehGestor): ?>
        <a href="/dashboard-ti" class="<?= $classeItem('dashboard-ti') ?>">
            <svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 002 2h2a2 2 0 002-2"/>
            </svg>
            Painel de Chamados
